...
def SpinRotation(dynpy_params):
    ...
    for traj in trajs:
        ...
        #print(u.atom_two.tail())
        time1 = time.time()
        print("compute_atom_two                        --- {t:.2f} seconds ---".format(t = time1 - start_time))
        
        u.compute_molecule()
        time2 = time.time()
        print("compute_molecule                        --- {t:.2f} seconds ---".format(t = time2 - time1))
        #print(u.molecule) 
        ...
        #time3 = time.time()
        #print("sort,slice,and add masses to dfs        --- %03.2s seconds ---" % (time3 - time2))
        ...
        #time4 = time.time()
        #print("map columns to atom_two                 --- %03.2s seconds ---" % (time4 - time3))
        ...
        time3 = time.time()
        #print("group dataframes by molecule            --- %03.2s seconds ---" % (time5 - time4))
        print("add atomic masses to data. Sort, slice, and group --- {t:.2f} seconds ---".format(t = time3 - time2))
        ...
        print("Total SR Run Time     --- {t:.2f} seconds ---".format(t = time.time() - start_time))
